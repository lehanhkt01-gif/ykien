    ...
    if (record) {
      ...
      resultBox.innerHTML = `
        <div style="border-left: 4px solid #EF4444; padding-left: 14px;">
          ...
          <p style="font-size:0.88rem; color:#4B5563; margin-top:4px;">Vui lòng kiểm tra lại mã hồ sơ hoặc liên hệ Email <strong>easupsohoa@gmail.com</strong> (Zalo: <strong>Mặt trận Ea Súp</strong>) để được hỗ trợ tra cứu trực tiếp.</p>
        </div>
      `;
    }
  }
